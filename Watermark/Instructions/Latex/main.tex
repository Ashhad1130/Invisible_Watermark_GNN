...
%-- Float placement tuning (prevents pile-up at end of document) --%
...
\renewcommand\section{\@startsection{section}{1}{\z@}%
  {-2.0ex \@plus -0.8ex \@minus -.2ex}{0.8ex \@plus .2ex}%
  {\normalfont\normalsize\bfseries\MakeUppercase}}
\renewcommand\subsection{\@startsection{subsection}{2}{\z@}%
  {-1.6ex \@plus -0.8ex \@minus -.2ex}{0.4ex \@plus .1ex}%
  {\normalfont\normalsize\itshape}}
\renewcommand\subsubsection{\@startsection{subsubsection}{3}{\z@}%
  {-1.2ex \@plus -0.4ex \@minus -.2ex}{0.2ex \@plus .1ex}%
  {\normalfont\normalsize\bfseries}}
\makeatother
...
on all seven attacks (4/7 within $\pm$0.01; three geometric/noise
attacks differ 0.05--0.06 due to SD v1.5 vs.\ v2.1) --- we design and evaluate
...
on 12/13 attacks, resolves all four FAIL conditions of the baseline,
and achieves 0.996 on crop\_0.75 ($+$0.090 over baseline; cf.\ paper's 0.97 on SD v2.1).
...
\label{sec:intro}
\textit{Main contributor: Saliq Neyaz.}
...
blind human evaluations~\cite{saharia2022imagen}, achieving creative
quality competitive with professional photography in many domains.
...
Generative AI can be used to improve effectiveness, efficiency, and creativity
...
of AI-generated content in Article~50(4), requiring that AI systems
...
\begin{enumerate}
  \item \textbf{Paper-accurate replication.}
    ...
    Wen et al.~\cite{wen2023treering} (4/7 within $\pm$0.01; three
    geometric/noise attacks differ by 0.05--0.06 due to SD v1.5 vs.\ v2.1), validating our implementation pipeline.
...
for both generation and inversion, reducing the inversion error and improving the recovery of the embedded watermark signal.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lccccc}
    ...
    \midrule
    Spread-spectrum~\cite{cox1997watermarking} & \checkmark & & & & \\
...
(0.920 $\to$ baseline AUC vs.\ 0.920 at $45^\circ$, 0.928 at $75^\circ$
...
\section{Methodology}
\label{sec:methods}
\textit{Main contributors: Saliq Neyaz (§6.1--6.3), Ashhad Raza Quadri (§6.4--6.7), Maria Alejandra Pabon (§6.8--6.10).}
...
Wen et al.~\cite{wen2023treering} on the seven paper-reported attack
conditions (4/7 expected within $\pm$0.01; model-version gaps accepted).
...
\textbf{Saliq} led the Introduction and Related Work sections, implemented
Configs~B, O, and~MR, and authored the Experiments \& Results section.
\textbf{Ashhad} led Config~MR-AC, the ablation study, Background \&
Preliminaries, Conclusions \& Future Work, and all infrastructure
(checkpoint/resume, dataset pipeline, code review).
\textbf{Maria Alejandra} led the Theoretical Analysis, Experimental Setup,
and Ethical Considerations sections, and co-authored the Methodology
(attack protocol, configuration summary, success criteria).
...
\begin{enumerate}
  ...
  \item \textbf{Multi-ring inner radius selection.}
    ...
    \textbf{Resolution}: Maria derived the crop frequency bound
    analytically (Section~\ref{sec:theory}); Saliq re-ran with
    $r_{\mathrm{in}}{=}4$, confirmed the prediction, and resolved
    the FAIL on crop\_0.75.
\end{enumerate}
...
all seven Wen et al.\ AUC values (4/7 within $\pm$0.01; three geometric/noise attacks differ by 0.05--0.06 due to SD v1.5 vs.\ v2.1) (Table~\ref{tab:auc}, Paper column).
...
MR-AllChan resolves all 4 Baseline FAIL conditions, with the
...
No artefacts were observed under close visual inspection
...
on img\_0016: the no-watermark reference, the clean
...
\begin{figure*}[tp]
  ...
  % Row 1: Baseline
  \noindent\textbf{Baseline} (N=50, ch=3, circle)\\[1pt]
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_baseline_category/no_attack/img_0016_no_wm.png}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_baseline_category/no_attack/img_0016_wm.png}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_baseline_category/jpeg_50/img_0016_wm_attacked.png}
  ...
  % Row 2: Optimized
  \noindent\textbf{Optimized} (N=100, ch=3, circle)\\[2pt]
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_optimized_category/rotation_45/img_0016_no_wm.png}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_optimized_category/rotation_45/img_0016_wm.png}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_optimized_category/rotation_45/img_0016_wm_attacked.png}
  ...
  % Row 3: Multi-Ring
  \noindent\textbf{Multi-Ring} (N=100, ch=3, dual-band)\\[2pt]
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_multi_ring_category/no_attack/img_0016_no_wm.png}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_multi_ring_category/no_attack/img_0016_wm.png}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_multi_ring_category/rotation_45/img_0016_wm_attacked.png}
  ...
  % Row 4: MR-AllChan
  \noindent\textbf{MR-AllChan} (N=100, ch=all, dual-band)\\[2pt]
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_multi_ring_allchan_category/no_attack/img_0016_no_wm.png}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_multi_ring_allchan_category/no_attack/img_0016_wm.png}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth,height=2.6cm,keepaspectratio]{../../experiment/outputs/large_multi_ring_allchan_category/rotation_45/img_0016_wm_attacked.png}
    \caption*{Rotation $45^\circ$ (AUC=0.986)}
  \end{subfigure}

  \caption{\textbf{Cross-configuration visual comparison (img\_0016).}
...
\begin{figure*}[tp]
  ...
  \begin{tabular}{r *{9}{c}}
    &
    {\scriptsize\textit{No attack}} &
    {\scriptsize\textit{JPEG 50}} &
    {\scriptsize\textit{JPEG 25}} &
    {\scriptsize\textit{Blur $\sigma$4}} &
    {\scriptsize\textit{Blur $\sigma$8}} &
    {\scriptsize\textit{Bright$\times$3}} &
    {\scriptsize\textit{Bright$\times$6}} &
    {\scriptsize\textit{Noise 0.05}} &
    {\scriptsize\textit{Noise 0.1}} \\[2pt]
    \rotatebox{90}{\scriptsize\textbf{Baseline}} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_baseline_category/no_attack/img_0016_wm.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_baseline_category/jpeg_50/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_baseline_category/jpeg_25/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_baseline_category/gaussian_blur_4/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_baseline_category/gaussian_blur_8/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_baseline_category/brightness_3/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_baseline_category/brightness_6/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_baseline_category/gaussian_noise_0.05/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_baseline_category/gaussian_noise_0.1/img_0016_wm_attacked.png} \\[-1pt]
    & {\tiny 1.000} & {\tiny 1.000} & {\tiny 0.999} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 0.995} & {\tiny 0.996} & {\tiny 0.931} \\[4pt]
    \rotatebox{90}{\scriptsize\textbf{Optimized}} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_optimized_category/no_attack/img_0016_wm.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_optimized_category/jpeg_50/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_optimized_category/jpeg_25/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_optimized_category/gaussian_blur_4/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_optimized_category/gaussian_blur_8/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_optimized_category/brightness_3/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_optimized_category/brightness_6/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_optimized_category/gaussian_noise_0.05/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_optimized_category/gaussian_noise_0.1/img_0016_wm_attacked.png} \\[-1pt]
    & {\tiny 1.000} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 0.996} & {\tiny 0.992} & {\tiny 0.936} \\[4pt]
    \rotatebox{90}{\scriptsize\textbf{Multi-Ring}} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_category/no_attack/img_0016_wm.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_category/jpeg_50/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_category/jpeg_25/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_category/gaussian_blur_4/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_category/gaussian_blur_8/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_category/brightness_3/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_category/brightness_6/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_category/gaussian_noise_0.05/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_category/gaussian_noise_0.1/img_0016_wm_attacked.png} \\[-1pt]
    & {\tiny 1.000} & {\tiny 1.000} & {\tiny 0.999} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 0.996} & {\tiny 0.988} & {\tiny 0.997} & {\tiny 0.932} \\[4pt]
    \rotatebox{90}{\scriptsize\textbf{MR-AllChan}} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/no_attack/img_0016_wm.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/jpeg_50/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/jpeg_25/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/gaussian_blur_4/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/gaussian_blur_8/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/brightness_3/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/brightness_6/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/gaussian_noise_0.05/img_0016_wm_attacked.png} &
    \includegraphics[width=0.099\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/gaussian_noise_0.1/img_0016_wm_attacked.png} \\[-1pt]
    & {\tiny 1.000} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 1.000} & {\tiny 0.999} & {\tiny 0.992} & {\tiny 0.963} \\
  \end{tabular}
  \caption{\textbf{Photometric attacks --- all four configurations on img\_0018.}
    Rows: Baseline ($N{=}50$, 3\,ch, circle) / Optimized ($N{=}100$, 3\,ch, circle) /
    Multi-Ring ($N{=}100$, 3\,ch, dual-band) / MR-AllChan ($N{=}100$, 4\,ch, dual-band).
    Columns: clean watermark then 8 photometric attacks.
    Numbers below each thumbnail are AUC values from the full 50-image evaluation.
    All configurations achieve AUC $\geq 0.931$ across all photometric conditions;
    MR-AllChan is consistently best under additive noise.}
...
MR-AllChan achieves the largest gap (31.52) despite using a dual-band
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lccc}
    ...
    MR-AllChan & 82.87 & 51.34 & \textbf{31.52} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table*}[tp]
  ...
  \begin{tabular}{lccccc}
    ...
    rotation\_75
      & \warn{0.9284} & \warn{0.9422} & \fail{0.9186} & \pass{\bf 0.9856} & 0.99 \\
    \midrule
    PASS count & 8 & 8 & 9 & \textbf{12} & --- \\
    WARN count & 1 & 3 & 1 & 1            & --- \\
    FAIL count & 4 & 2 & 3 & \textbf{0}  & --- \\
    \bottomrule
  \end{tabular}
\end{table*}

\paragraph{RQ1 -- Baseline replication.}
The Baseline reproduces all seven paper attacks:
...
Gaps of 0.05--0.06 on the last three reflect SD v1.5 vs.\ v2.1; the PASS/WARN/FAIL pattern is preserved. \textbf{RQ1: confirmed.}
...
achieves 0.996 on crop\_0.75 ($+$0.090 over baseline; cf.\ paper's 0.97 on SD v2.1).
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lccccc}
    ...
    g\_noise\_0.1  & \warn{0.54} & \warn{0.50} & \fail{0.32} & \warn{\bf 0.78} & 0.93 \\
    crop\_0.75     & \warn{0.52} & \warn{0.52} & \warn{0.64} & \pass{\bf 0.80} & 0.89 \\
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{TPR@1\%FPR} across all conditions.
    ...
    Even MR-AllChan leaves g\_noise\_0.1, crop\_0.5, rotation\_45, rotation\_75 in
    WARN, highlighting the fundamental difficulty of geometric distortions
    and high noise at strict FPR constraints.}
  \label{fig:tpr}
\end{figure}

TPR@1\%FPR is substantially more demanding than AUC.
MR-AllChan achieves PASS AUC on 12/13 but PASS TPR@1\%FPR on only 9/13
(g\_noise\_0.1, crop\_0.5, rotation\_45, rotation\_75 are WARN).
...
Closing the gap on the geometric WARN conditions likely requires
...
\begin{figure*}[tp]
  ...
  \begin{tabular}{r cccc}
    ...
    {\small\textit{Crop 75\%}} &
    {\small\textit{Crop 50\%}} &
    {\small\textit{Rotation $45^\circ$}} &
    {\small\textit{Rotation $75^\circ$}} \\[2pt]
    \rotatebox{90}{\scriptsize\textbf{Baseline}} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_baseline_category/crop_0.75/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_baseline_category/crop_0.5/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_baseline_category/rotation_45/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_baseline_category/rotation_75/img_0016_wm_attacked.png} \\[-1pt]
    & {\small 0.906} & {\small 0.889} & {\small 0.920} & {\small 0.928} \\[4pt]
    \rotatebox{90}{\scriptsize\textbf{Optimized}} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_optimized_category/crop_0.75/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_optimized_category/crop_0.5/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_optimized_category/rotation_45/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_optimized_category/rotation_75/img_0016_wm_attacked.png} \\[-1pt]
    & {\small 0.892} & {\small 0.882} & {\small 0.930} & {\small 0.942} \\[4pt]
    \rotatebox{90}{\scriptsize\textbf{Multi-Ring}} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_multi_ring_category/crop_0.75/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_multi_ring_category/crop_0.5/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_multi_ring_category/rotation_45/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_multi_ring_category/rotation_75/img_0016_wm_attacked.png} \\[-1pt]
    & {\small 0.974} & {\small 0.892} & {\small 0.894} & {\small 0.919} \\[4pt]
    \rotatebox{90}{\scriptsize\textbf{MR-AllChan}} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/crop_0.75/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/crop_0.5/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/rotation_45/img_0016_wm_attacked.png} &
    \includegraphics[width=0.232\textwidth]{../../experiment/outputs/large_multi_ring_allchan_category/rotation_75/img_0016_wm_attacked.png} \\[-1pt]
    & {\small 0.996} & {\small 0.980} & {\small 0.986} & {\small 0.986} \\
  \end{tabular}
  \caption{\textbf{Geometric attacks --- all four configurations on img\_0018.}
    Rows: Baseline / Optimized / Multi-Ring / MR-AllChan.
    Numbers below each image are AUC values (50-image evaluation).
    Crop and rotation scramble the Fourier ring structure, making these
    the hardest attacks; MR-AllChan (bottom row) achieves AUC $\geq 0.980$
    on all four conditions, a $\Delta$AUC $\approx 0.07$--$0.09$ gain over
    the single-channel baseline.}
...
slightly degrading rotation robustness ($-$0.036 on rotation\_45,
...
\textit{Main contributors: Ashhad Raza Quadri (§10.1--10.3), Maria Alejandra Pabon (§10.4--10.6), Saliq Neyaz (§10.7--10.8).}
...
\textbf{Why rotation\_75 remains WARN at TPR@1\%FPR despite AUC 0.986.}
This asymmetry --- strong AUC but only WARN TPR --- has a precise
mechanistic cause.
A rotation by $\theta$ degrees maps a Fourier coefficient at radius
$\rho$ to a new angle, introducing a phase shift proportional to
$\rho\theta$.
For small $\theta$ (e.g., rotation\_45), the phase shift is moderate
and all-channel averaging reduces residual error below the 1\%~FPR
threshold for most images.
At $\theta{=}75^\circ$, the rotation-induced phase shift at the outer
ring ($\rho{=}10$) is large enough that the per-image L1 score
exhibits a long right tail: most images score clearly above the
threshold (hence high AUC), but a minority of images with
unfavourable Fourier phase structure at $\rho{=}10$ score near the
boundary, pushing the TPR@1\%FPR into WARN (0.64).
Critically, all-channel aggregation reduces \emph{random}, i.i.d.\
phase noise across channels but cannot correct the \emph{systematic}
phase misalignment from rotation, which is identical across all
four latent channels (since the VAE encoder applies the same
spatial transformation to every channel independently).
The four channels are correlated under rotation, not independent,
so the $\sqrt{4}$ SNR argument does not fully apply in the tail.
Solving this would require either (1) rotation angle estimation and
pre-compensation before inversion, or (2) a rotation-invariant
detection statistic (e.g., aggregating L1 error over the full annulus
rather than at fixed Fourier coordinates).
...
EU AI Act Article~50(4) and C2PA both require content provenance
mechanisms for AI-generated images, but neither specifies a minimum
TPR threshold.
MR-AllChan's TPR@1\%FPR of $\geq$0.80 on 9/13 attack conditions ---
including all blur and JPEG attacks --- provides a concrete empirical
...
The four WARN conditions (g\_noise\_0.1, crop\_0.5, rotation\_45/75) require
significant signal disruption or image degradation, making them
...
\textbf{RQ1 (confirmed):}
Our Baseline reproduces all seven Wen et al.\ AUC values; 4/7 match within $\pm$0.01 and three geometric/noise attacks differ by 0.05--0.06 (SD v1.5 vs.\ v2.1), with the PASS/WARN/FAIL pattern fully preserved.
...
PASS on 12/13 attacks, eliminates all 4 Baseline FAIL conditions, and
achieves 0.996 on crop\_0.75 ($+$0.090 over baseline; cf.\ paper's 0.97 on SD v2.1).
...
Tables~\ref{tab:contributions_a} and~\ref{tab:contributions_b} provide a task-level breakdown for grading purposes.
Each cell uses: \textbf{L}~=~Lead (primary owner and decision-maker),
\textbf{S}~=~Support (significant contribution),
\textbf{R}~=~Review / validation only,
\textbf{--}~=~not involved.

% Table A — Literature, Implementation, Infrastructure, Theory
\begin{table}[htbp]
  \centering
  \caption{Contribution matrix (part~1 of~2): research and coding tasks.
    \textbf{L}~=~Lead, \textbf{S}~=~Support, \textbf{R}~=~Review, \textbf{--}~=~not involved.}
  \label{tab:contributions_a}
  \footnotesize
  \setlength{\tabcolsep}{3pt}
  \begin{tabular}{lp{2.9cm}ccc}
    \toprule
    \textbf{Cat.} & \textbf{Task} & \textbf{Ash.} & \textbf{Maria} & \textbf{Saliq} \\
    \midrule
    \multirow{3}{*}{\textit{Lit.}}
      & Related-work survey        & S & R & L \\
      & Tree-Ring paper study      & L & S & S \\
      & Freq.-domain background    & S & L & R \\[2pt]
    \multirow{4}{*}{\textit{Impl.}}
      & Baseline (Config~B)        & L & S & R \\
      & Step optimisation (O)      & L & S & R \\
      & Dual-band mask (MR)        & L & S & R \\
      & All-channel (MR-AC)        & L & S & R \\[2pt]
    \multirow{3}{*}{\textit{Infra.}}
      & Checkpoint / resume        & L & S & R \\
      & Attack protocol            & L & S & R \\
      & Dataset pipeline           & L & S & R \\[2pt]
    \multirow{3}{*}{\textit{Theory}}
      & Inversion-error proof      & L & S & R \\
      & Crop / blur freq.\ analysis & L & S & R \\
      & SNR, rotation \& noise     & L & S & R \\
    \bottomrule
  \end{tabular}
\end{table}

% Table B — Experiments, Analysis, Report Writing, Quality, Effort
\begin{table}[htbp]
  \centering
  \caption{Contribution matrix (part~2 of~2): experiments, writing, and quality.}
  \label{tab:contributions_b}
  \footnotesize
  \setlength{\tabcolsep}{3pt}
  \begin{tabular}{lp{2.9cm}ccc}
    \toprule
    \textbf{Cat.} & \textbf{Task} & \textbf{Ash.} & \textbf{Maria} & \textbf{Saliq} \\
    \midrule
    \multirow{4}{*}{\textit{Expt.}}
      & Large-scale runs (50 img.) & L & S & S \\
      & Per-category analysis      & L & S & S \\
      & Ablation studies           & L & S & S \\
      & Statistical testing        & L & S & S \\[2pt]
    \multirow{3}{*}{\textit{Vis.}}
      & ROC / AUC / TPR plots      & S & R & L \\
      & Score distributions        & R & R & L \\
      & Figure generation          & L & S & S \\[2pt]
    \multirow{5}{*}{\textit{Writing}}
      & Introduction               & R & R & L \\
      & Related work               & R & R & L \\
      & Theory section             & R & L & -- \\
      & Methodology \& results     & L & S & S \\
      & Discussion \& conclusions  & L & S & S \\[2pt]
    \multirow{2}{*}{\textit{QA}}
      & Code review                & L & S & S \\
      & Report proof-read          & L & S & S \\
    \bottomrule
  \end{tabular}
\end{table}
